...
plot(df$exact_date_and_time, df$Voltage,  
...
plot(df$exact_date_and_time, df$Global_reactive_power,  
     xlab = 'datetime', ylab = 'Global_reactive_power', type = 'l', ylim = c(0.0, 0.5))
dev.off()